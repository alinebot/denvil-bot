...
async def alive(a):
    reply_msg = f"**[Denvil-userbot](https://github.com/alinebot/denvil-bot)**\n"
    reply_msg += f"`Status : Alive`\n"
    reply_msg += f"`Made By ❤ Using` Telethon\n"
    photo = "https://telegra.ph/file/5653e5eb845dc11a271e6.jpg"
    await a.delete()
